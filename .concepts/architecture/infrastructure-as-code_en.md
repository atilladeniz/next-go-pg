...
Complete automation of the HA architecture with Terraform, Pulumi, Ansible, and Kubernetes.

---

## Overview: IaC Tool Landscape
...
### Recommended Stack for Next-Go-PG

| Layer | Tool | Reason |
|-------|------|--------|
| **Cloud Infrastructure** | Terraform | Industry standard, multi-cloud |
| **Kubernetes** | Helm + Kustomize | Flexible, well documented |
| **GitOps** | ArgoCD | Kubernetes-native, UI |
| **Secrets** | External Secrets + Vault | Secure, automated |
| **CI/CD** | GitHub Actions | Already integrated in project |
...
## Phase 1: Cloud Infrastructure with Terraform
...
flowchart TB
    ...
    subgraph Providers["Cloud Providers"]
        Hetzner[Hetzner Cloud<br/>Budget, EU]
        AWS[AWS<br/>Enterprise]
        GCP[Google Cloud<br/>Kubernetes]
        DO[DigitalOcean<br/>Simple]
    end
...
# Firewall: Only Kubernetes Cluster Access
...
## Phase 2: Kubernetes with Helm & Kustomize
...
spec:
  ...
  template:
    ...
    spec:
      ...
      # Anti-Affinity: Distribute pods across different nodes
      affinity:
        podAntiAffinity:
      ...
      # Topology Spread: Evenly across Availability Zones
...
### Checklist: What is Managed as Code?
