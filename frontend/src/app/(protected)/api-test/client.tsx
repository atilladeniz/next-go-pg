...
export function ApiTestClient({ userEmail }: { userEmail: string }) {
		...
		<main className="mx-auto max-w-7xl px-4 py-8">
			<div className="mb-6 flex items-center justify-between">
				<div>
					...
					<p className="text-muted-foreground">Teste die Verbindung zum Go Backend ({API_BASE})</p>
				</div>
			...
			<div className="grid gap-4 md:grid-cols-2">
				...
				<Card className="md:col-span-2">
					<CardHeader>
						...
						<CardDescription>
							Authentifizierung erforderlich (eingeloggt als: {userEmail})
						</CardDescription>
					</CardHeader>
					<CardContent className="space-y-3">
						<TestRow
